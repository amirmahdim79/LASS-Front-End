...
export default function SearchBar({height='48px', borderRadius='15px', placeholder='جست و جو کنید'}) {  
    ...
    return (
        <div className={cs(styles['container'])}>
            ...
            >
                <input className={cs(styles['searchInput'])} type="text" placeholder={placeholder} />
